...
def reward_function(params):
    ...
    # Set threshold
    SPEED_THRESHOLD_1 = 2.5   # Straight line speed
    SPEED_THRESHOLD_2 = 1.3  # Cornering speed
    DIRECTION_THRESHOLD = 3.0  # Track direction and heading direction difference
